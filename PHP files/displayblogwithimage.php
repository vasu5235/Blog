...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home_page.php">Go Back</a>
            </div>
	...
	<?php
			...
			$blog_id = $_GET['var'];
			$query = $conn->query("SELECT * FROM blog_detail WHERE blog_id = '$blog_id' ");
			...
			//echo $image_path;
			$query->close();
			echo "<img src=".$image_path." height=350 width=100%><br>";
			...
			$sql2 = "SELECT blogger_is_active,blog_id, blog_title,blog_desc,blog_author, blog_category, creation_date,updated_date from blogger_info inner join blog_master ON blogger_info.blogger_id = blog_master.blogger_id order by blog_master.creation_date desc";
        ...
        <div class="row">
            ...
            <div class="col-md-*">
				<?php
					...
					$sql2 = "SELECT * FROM blog_master WHERE blog_id = '$blog_id'";
					$result = mysqli_query($conn, $sql2);
					$blog_array = array();
					if (mysqli_num_rows($result)>0){
						while($row = mysqli_fetch_assoc($result)) {
					...
					foreach($blog_array as $blog){
						...
						echo '<p class="lead">
							...
							/*
							echo '<p><a href="displayblogwithimage.php?var='.$blog['blog_author'].'" data-toggle="tooltip" title="Click here to read more '.$blog['blog_title'].'\'s detail"> Read more..</a>
								</p>';
							*/
...
/*
					...
					{	
						...
						if($blog['blogger_is_active'] == 1 and $cnt < 4){ //Displaying 5 most recent's blogs
							...
							$shortstrpos = strrpos($blog['blog_desc']," ",15);
							$shortstr = substr($blog['blog_desc'], 0, $shortstrpos);
							echo '<p>'.$shortstr.'...........<a href="displayblogwithimage.php?var='.$blog['blog_author'].'" data-toggle="tooltip" title="Click here to read more '.$blog['blog_title'].'\'s detail"> Read more..</a>
							</p>';
